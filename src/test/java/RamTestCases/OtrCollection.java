...
//		cap.setCapability("autoGrantPermission", "true");
	...
	public void CaseToVerifyRejectCollection() throws InterruptedException {
		...
		OntheRoad .click();
		MobileElement Returntohub = (MobileElement) driver.findElementById("com.ram.courier:id/ll_return_hub");
		Returntohub.click();
		MobileElement okBtnOnReturntoHubPopUp = (MobileElement) driver.findElementById("android:id/button1");
...
// Reject Collection
		...
		el3.click();
		MobileElement el4 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_reject");
		el4.click();
		MobileElement el5 = (MobileElement) driver.findElementById("com.ram.courier:id/tv_reason1");
		el5.click();
...
////		el3.click();
//		MobileElement pendingTab = (MobileElement) driver.findElementByAccessibilityId("Pending(4)");
//		pendingTab.click();
...
//		el7.click();
	...
	public void CaseToVerifyNextBtn() throws InterruptedException {
		...
		MobileElement el1 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_proceed_collection");
		el1.click();
...
//		MobileElement pendingTab = (MobileElement) driver.findElementByAccessibilityId("Pending(3)");
//		pendingTab.click();
////		el8.click();
...
//		el10.click();
	...
	public void CaseToVerifyAcceptCollection() throws InterruptedException {
		...
		el3.click();
		MobileElement el4 = (MobileElement) driver.findElementById("com.ram.courier:id/cb_select_consignment");
		el4.click();
		el4.click();
		MobileElement el5 = (MobileElement) driver.findElementById("com.ram.courier:id/cb_select_consignment");
		el5.click();
		MobileElement el6 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_proceed_collection");
		el6.click();
		MobileElement el7 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_accept");
		el7.click();
...
//		el13.click();
	...
	@Test(description= " Select Multiple reason to check fields.' ",priority= 3)
...
//		                                                                     /hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[3]/android.widget.LinearLayout/android.widget.CheckBox
		...
		MobileElement el2 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_proceed_collection");
		el2.click();
		MobileElement el3 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_missed");
		el3.click();
...
//	}
	...
	public void CaseToVerifySelectConsignmentforMissedCollectionReason1n2() throws InterruptedException {
		...
		MobileElement el4 = (MobileElement) driver.findElementById("com.ram.courier:id/tv_select_reason");
		el4.click();
		...
		el5.click();
		MobileElement el6 = (MobileElement) driver.findElementById("com.ram.courier:id/tv_select_reason");
		el6.click();
...
//		el25.click();
	...
	public void CaseToVerifySelectConsignmentforMissedCollectionReason3() throws InterruptedException {
		...
		el7.click();
		MobileElement el8 = (MobileElement) driver.findElementById("com.ram.courier:id/tv_select_reason");
		el8.click();
...
//		el31.click();
	...
	public void CaseToVerifySelectConsignmentNFollowCollectionProcessCancelBtn() throws InterruptedException {
		...
		el6.click();
		MobileElement el7 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_add_waybill");
		el7.click();
		MobileElement el8 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_proceed");
		el8.click();
		MobileElement el9 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_cancel");
		el9.click();
...
//		el45.click();
	...
	public void CaseToVerifySelectConsignmentNFollowCollectionProcessYesBtn() throws InterruptedException {
		...
		el10.click();
		MobileElement el11 = (MobileElement) driver.findElementById("com.ram.courier:id/btn_yes");
		el11.click();
...
////		el16.click();
		...
		MobileElement clickOnSave = (MobileElement) driver.findElementById("com.ram.courier:id/btn_save");
		clickOnSave.click();
...
//		el57.click();
	...
	@Test(description= "Verify collection details" ,priority= 9)

	public void VerifyCollectioDetail() throws InterruptedException {
